...
/**
 * @Class Name : EgovSndngMailServiceImpl.java
 * @Description : EgovSndngMailServiceImpl 메일 발송 Class
 ...
 * @see
 *  
 *  egovframework '일반용 및 첨부파일 미사용 발송메일 구현 예제' 참조
...
public class EgovSndngMailServiceImpl extends EgovAbstractServiceImpl implements EgovSndngMailService {
    ...
    public boolean sndngMail(SndngMailVO sndngMailVO) throws Exception {
    	...
    	try{
	    	/**
	    	 * SMTP 메일 보내기 로직
	    	 * 1. globals.properties SMTP 정보 불러오기
	    	 * 2. SMTP 인증 및 session 연결
	    	 * 3. 메일 전송
	    	 */
