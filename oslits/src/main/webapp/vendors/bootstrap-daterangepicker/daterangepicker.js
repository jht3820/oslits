...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        /*2018-10-26 진주영 - https://github.com/dangrossman/daterangepicker/issues/1185*/
        ...
        renderCalendar: function(side) {
            ...
            if (this.showDropdowns) {
                ...
                try{
                for (var m = 0; m < 12; m++) {
                	/*2018-10-30 진주영 수정 - !minDate , !maxDate*/
    ...
    $.fn.daterangepicker = function(options, callback) {
	    ...
	    /*2018-10-26 - 진주영*/
            ...
            if(!$(this).next().hasClass("ui-datepicker-trigger")){
            	$(this).parent().append('<img class="ui-datepicker-trigger" src="/images/calendar.png" alt="..." title="...">');
