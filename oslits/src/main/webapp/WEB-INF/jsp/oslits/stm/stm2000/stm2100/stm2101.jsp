...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		/* 취소 */
		$('#btnStm2101Cancle').click(function() {
			gfnLayerPopupClose();
		});
		
		$('#btnStm2101Select').click(function() {
					...
					rows:[
						{display:true, addClass:"", style:"", list:[
							...
							{label:"", labelWidth:"", type:"inputText", width:"120", key:"searchTxt", addClass:"secondItem sendBtn", valueBoxStyle:"padding-left:0px;", value:"",
								onkeyup:function(e){
									if(e.keyCode == '13' ){
										axdom("#" + popSearch.getItemId("btn_search_svn")).click();
									}
								} 
							},
							...
							{label:"", labelWidth:"", type:"button", width:"55", key:"btn_search_svn",valueBoxStyle:"padding-left:0px;padding-right:2px;", value:"<i class='fa fa-list' id='btn_search_api' aria-hidden='true'></i>&nbsp;<span>조회</span>",
							onclick:function(){
								/* 검색 조건 설정 후 reload */
	...
	function fnAxGridSet(){
        ...
        popGrid.setConfig({
            ...
            columns: [
				...
				{key: "svnRepNm", label: "REPOSITORY 명", width: 200, align: "left"},
				{key: "svnTxt", label: "REPOSITORY 설명", width: 200, align: "left"},
				{key: "svnRepUrl", label: "URL", width: 100, align: "center"},
	...
	function fnInGridPopListSet(ajaxParam){
		...
		var ajaxObj = new gfnAjaxRequestAction(
				{"url":"<c:url value='/stm/stm2000/stm2100/selectStm2100ProjectAuthList.do'/>","loadingShow":false}
				,ajaxParam);
		//AJAX 전송 성공 함수
	...
	function fnInSaveGrid(objects,prjId){
		...
		for(var i=0; i<objects.length; i++){
			params += "&svnRepId="+objects[i].svnRepId;
	 	...
	 	//AJAX 설정
		var ajaxObj = new gfnAjaxRequestAction(
				{"url":"<c:url value='/stm/stm2000/stm2100/saveStm2100Ajax.do'/>","loadingShow":true}
				,params);
		//AJAX 전송 성공 함수
		ajaxObj.setFnSuccess(function(data){
			data = JSON.parse(data);
...
<div class="popup">
	...
	<div class="pop_title">REPOSITORY 허용 설정</div>
	<div class="pop_sub">
		<div class="tab_contents menu" style="max-width:600px;">
			<form:form commandName="svn1100VO" id="searchFrm" name="searchFrm" method="post" onsubmit="return false"></form:form>
		...
		<div class="btn_div">
			<div class="button_normal save_btn"  id="btnStm2101Select" >선택</div>
			<div class="button_normal exit_btn" id="btnStm2101Cancle" >취소</div>
		</div>
	</div>
	</form>
</div>
