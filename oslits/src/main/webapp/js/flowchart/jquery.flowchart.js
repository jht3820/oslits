...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            /** 2018-07-23 진주영 추가
             * properties에 색상 값 있는 경우 반영
             * flowTitleBgColor			:	제목 배경색
             * flowTitleColor			:	제목 글씨색
             * flowContentBgColor		:	내용 배경색
             ...
             * flowDpl					:	배포계획 체크
             * flowOptCnt				:	추가 항목 갯수
             * flowNextId				:	연결된 다음 작업흐름 Id
             * 
             * -수정
             * 2018-08-06 	필수,결재,종료 아이콘 추가		진주영
             * 2018-08-07	추가 항목 갯수 추가			진주영	
             * 2018-08-23	flowNextId없는경우 종료분기	진주영
          ...
          //  var flowNextId = operatorData.properties.flowNextId;
            ...
            var $operator = $('<div class="flowchart-operator" style="background-color:'+flowContentBgColor+';color:'+flowContentColor+';border-width:3px;border-style:solid;border-color:'+flowTitleBgColor+'"></div>');
            $operator.addClass(infos.class);

            /** 2018-08-06 진주영 추가
             * 필수, 결재, 종료에 체크 되어있다면 제목에 아이콘 추가
             */
            var flowIcon = "";
/*            //flowNextId 없는경우
            ...
            $operator_title.html(flowIcon+infos.title);
