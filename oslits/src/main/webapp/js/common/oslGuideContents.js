var globals_guideContents =
	{
		//운영 대시보드
		"dsh1000":
			[{id:"dshGuide_autoRefresh",target:"autoRefresh",mainTitle:"[자동 조회 기능]",top:30,left:600,position:"right",targetPosition:"left"
						,subBox:[
		...
		//개발 대시보드
		,"dsh2000":
			[{id:"dsh2000_autoRefresh",target:"dsh2000AutoRefresh",mainTitle:"[자동 조회 기능]",top:30,left:600,position:"right",targetPosition:"left"
				,subBox:[
				         {title:"<i class='fa fa-clock'></i>",content:"자동 조회까지 남은 시간"}
				         ,{title:"<i class='fa fa-infinity'></i>",content:"자동 조회 중지 상태"}
				         ,{title:"<i class='fa fa-cogs'></i>",content:"자동 조회 시간 설정"}
			...
			,{id:"dsh2000_request",target:"dsh2000Request",mainTitle:"[접수 대기 요청사항]",top:1150,left:160,position:"left",targetPosition:"left"
				,subBox:[
				         {title:"접수 대기",content:"접수된 요청사항 대기 목록"}
				         ,{title:"두번 클릭",content:"접수 대기 요청사항 두번 클릭시 접수 승인&반려 업무 화면 팝업"}
			         ]}
			...
			,{id:"dsh2000_signList",target:"dsh2000SignList",mainTitle:"[담당 결재 목록]",top:1300,left:100,position:"bottom",targetPosition:"top", curve:false
				,subBox:[
				         {title:"담당 결재 목록",content:"담당자가 결재를 해야할 목록이 표시됩니다. <br/>결재 목록을 더블클릭 하여 결재 승인/반려를 할 수 있습니다."}
			         ]}
			,{id:"dsh2000_workList",target:"dsh2000WorkList",mainTitle:"[담당 작업 목록]",top:1300,left:700,position:"bottom",targetPosition:"top", curve:false
				,subBox:[
		...
		,"req4105":
			[{id:"reqGuide_topFlowList",target:"req4105TopFlowList",mainTitle:"[작업흐름 변경이력]",top:180,left:100,position:"top"
						...
						{id:"reqGuide_hlafSave",target:"req4105HlafSave",mainTitle:"[임시 저장]",top:600,left:50,position:"bottom",targetPosition:"top",curve:false
						,subBox:[
						         {title:"임시 저장",content:"업무 진행없이 입력된 정보만 저장합니다.</br>결재 기능이 있는경우 결재는 진행되지 않습니다."}
						         ]},
						{id:"reqGuide_flowNext",target:"req4105FlowNext",mainTitle:"[다음]",top:600,left:520,position:"bottom",targetPosition:"top",curve:false
						,subBox:[
						...
						{id:"reqGuide_signReject",target:"req4105SignReject",mainTitle:"[결재 반려]",top:600,left:520,position:"bottom",targetPosition:"top",curve:false
						,subBox:[
			...
			[{id:"flwGuide_leftMenu",target:"leftMenu",mainTitle:"[프로세스 기능]",top:2,left:300,position:"left",targetPosition:"right"
					...
					{id:"flwGuide_functionList",target:"functionList",mainTitle:"[기능 목록]",top:290,left:300,position:"bottom",targetPosition:"top"
						,subBox:[
						         ...
						         ,{title:"추가 항목 관리",content:"권한있는 체계의 확정된 프로세스를 복사"}
						         ]},
		...
		,// 사용자 관리
		"adm2000":   
			[  {id:"admGuide_adm2000button",target:"adm2000button",mainTitle:"[사용자 관리]",top:233,left:80,position:"left",targetPosition:"left"
				,subBox:[
		...
		,"dpl1003":
			...
			{id:"dpl1003_dplHistory",target:"dpl1003DplHistory",mainTitle:"[배포 이력 정보]",top:330,left:540,position:"bottom",targetPosition:"right", curve:false
				,subBox:[
				         	...
				         	,{title:"결제 이력", content:"해당 배포 계획의 결제 이력이 시간순으로 표시됩니다."}
		...
		// 배포 계획 결제 요청현황
		,"dpl2000":
				[{id:"dpl2000_dplSignGrid",target:"dplSignGrid",mainTitle:"[배포 계획 결제 요청 목록]",top:410,left:200,position:"left",targetPosition:"left",curve:false
					,subBox:[
					         	{title:"<i class='fas fa fa-list' title='배포 계획 결제 요청 목록'></i>&nbsp;배포 계획 결제 요청 목록",content:"배포 계획의 결제 요청 목록이 표시됩니다. <br/>결제 요청 목록은 로그인한 사용자가 올린 배포 계획 결제 요청만 표시됩니다."}
					         	,{title:"<i class='fa fa-search' title='배포 계획 상세보기'></i>&nbsp;배포 계획 상세보기", content:"[팝업] 배포 계획 결제 요청 목록에서 배포 계획을 더블클릭 하면, <br/>해당 배포 계획의 상세보기 팝업이 나타납니다."}
					         ]},
				{id:"dpl2000_dplSignGridBtn",target:"dplSignGridBtn",mainTitle:"[배포 계획 결제 요청 목록 버튼영역]",top:250,left:780,position:"right",targetPosition:"right"
					,subBox:[
								{title:"<i class='fas fa fa-list' title='목록 수'></i>&nbsp;목록 수", content:"그리드 한 페이지에 표시될 배포 계획 결제 요청 목록 수를 지정합니다."}
								,{title:"<i class='fas fa-sort-amount-down' title='목록 높이'></i>&nbsp;목록 높이", content:"결제 요청 목록 그리드의 높이를 변경합니다."}
								,{title:"<i class='fas fa fa-list' title='조회'></i>&nbsp;조회", content:"등록된 배포 계획 결제 요청 목록을 조회합니다."}
								,{title:"<i class='fa fa-file-excel' title='엑셀'></i>&nbsp;엑셀", content:"배포 계획 결제 요청 목록을 엑셀 파일로 다운로드 합니다."}
								,{title:"<i class='fa fa-print' title='프린트'></i>&nbsp;프린트", content:"배포 계획 결제 요청 목록을 프린트 합니다."}
					         ]}
				]
		// 배포 계획 결제 승인관리
		,"dpl2100":
				[{id:"dpl2100_dplSignGrid",target:"dplSignApprovalGrid",mainTitle:"[배포 계획 결제 요청 목록]",top:410,left:200,position:"left",targetPosition:"left",curve:false
					,subBox:[
					         	{title:"<i class='fas fa fa-list' title='배포 계획 결제 요청 목록'></i>&nbsp;배포 계획 결제 요청 목록",content:"배포 계획의 결제 요청 목록이 표시됩니다."}
					         	,{title:"<i class='fa fa-search' title='배포 계획 상세보기'></i>&nbsp;배포 계획 상세보기", content:"[팝업] 배포 계획 결제 요청 목록에서 배포 계획을 더블클릭 하면, <br/>해당 배포 계획의 상세보기 팝업이 나타납니다."}
					         ]},
				{id:"dpl2100_dplSignGridBtn",target:"ddplSignApprovalGridBtn",mainTitle:"[배포 계획 결제 요청 목록 버튼영역]",top:300,left:920,position:"top",targetPosition:"bottom",curve:false
					,subBox:[
								{title:"<i class='fa fa-check' title='승인'></i>&nbsp;승인", content:"결제 요청 배포 계획을 승인합니다. 결제 상태가 대기인 배포 계획만 승인 가능합니다."}
								,{title:"<i class='fa fa-trash-alt' title='반려'></i>&nbsp;반려", content:"결제 요청 배포 계획을 반려합니다. 결제 상태가 대기인 배포 계획만 반려 가능합니다."}
								,{title:"<i class='fas fa fa-list' title='목록 수'></i>&nbsp;목록 수", content:"그리드 한 페이지에 표시될 배포 계획 결제 요청 목록 수를 지정합니다."}
								,{title:"<i class='fas fa-sort-amount-down' title='목록 높이'></i>&nbsp;목록 높이", content:"결제 요청 목록 그리드의 높이를 변경합니다."}
								,{title:"<i class='fas fa fa-list' title='조회'></i>&nbsp;조회", content:"등록된 배포 계획 결제 요청 목록을 조회합니다."}
								,{title:"<i class='fa fa-file-excel' title='엑셀'></i>&nbsp;엑셀", content:"배포 계획 결제 요청 목록을 엑셀 파일로 다운로드 합니다."}
		...
		// 요구사항 WBS
		,"req4600":
			[{id:"req4600Guide_wbsBtn",target:"req4600button",mainTitle:"[WBS 버튼영역]",top:304,left:20,position:"top",targetPosition:"left"//, curve:false
				,subBox:[
			...
			{id:"req4600Guide_wbsGantt",target:"req4600WbsGantt",mainTitle:"[WBS 차트]",top:420,left:900,position:"right",targetPosition:"right", curve:false
				,subBox:[
